...
pub struct Renderer {
    ...
    wallpaper_texture: WallpaperTexture,
}
impl Renderer {
    pub fn draw(&self, render_pass: &mut wgpu::RenderPass) {
        render_pass.set_pipeline(&self.wallpaper_pipeline);
        render_pass.set_bind_group(0, &self.wallpaper_texture.bind_group, &[]);
    ...
    pub fn new(
        ...
        let wallpaper_texture = WallpaperTexture::new(device, queue);
        ...
        let wallpaper_render_pipeline_layout =
            device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                ...
                bind_group_layouts: &[&wallpaper_texture.bind_group_layout],
